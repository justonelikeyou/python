...
PORT=8081
UUID=0bc76977-8a36-41cf-9a42-6af66d254d50
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/justonelikeyou/python/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/justonelikeyou/python/main/etc/xray.json
...
# Configs
mkdir -p /etc/caddy
wget -qO- $CaddyConfig | sed -e "1c :$PORT" >/etc/caddy/Caddyfile | sed -e "s/\$UUID/$UUID/g" >/etc/caddy/Caddyfile
